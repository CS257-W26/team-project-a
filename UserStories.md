1.
* User story: I input Canada to see what percentage of it's water is going to Agricultutal usage, Industrial usage and Household usage and find that the cooresponding percentages for the most recent year (2024) are 57%, 26.7%, 26.4%
* Acceptance Criteria: User can input "python3 command_line.py -usageproportion canada 2024" and it responds with the dates (accurate for the current year) of "Agricultral: 57%, Industrial: 26.7%, Household: 26.4%
