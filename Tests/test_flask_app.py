...
import unittest
from flask_app import home, water_use_route, usage_proportion_route, per_capita_route, page_not_found, app, api
...
class FlaskTest(unittest.TestCase):
    ...
    def test_404(self):
        ...
        self.assertEqual(result,"Page not found. Try re-entering the link.")
...
class TestFlaskApp(unittest.TestCase):
    ...
    def test_flask_app_water_use(self):
        ...
        self.assertIn("Water usage in United States of America\\n2003", str(response.data))
